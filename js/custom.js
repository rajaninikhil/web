...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //team
  // Cards
const cards = document.querySelectorAll('.cards-side .card');
...
const cardData = [
  {
    img: 'your-main-image.jpg',
    name: 'Emily Johnson',
    description: 'Emily is an expert writing coach with 10+ years of experience helping students craft compelling stories.'
  },
  {
    img: 'your-second-image.jpg',
    name: 'James Smith',
    description: 'James specializes in creative writing and journalism, inspiring hundreds of aspiring writers every year.'
  },
  {
    img: 'your-third-image.jpg',
    name: 'Laura Williams',
    description: 'Laura is a seasoned business coach and author who has empowered countless entrepreneurs worldwide.'
  }
];
...
cards.forEach(card => {
  card.addEventListener('click', function(e) {
    ...
    popupImage.src = cardData[index].img;
    popupName.textContent = cardData[index].name;
    popupDescription.textContent = cardData[index].description;
